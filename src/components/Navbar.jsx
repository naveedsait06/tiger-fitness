...
export default function Navbar({ activeTab, onTabChange }) {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-[#020203]/90 backdrop-blur-md border-b border-white/[0.03] px-8 md:px-16 py-5 flex items-center justify-between transition-all duration-300">
      ...
      <div className="flex items-center gap-6 flex-shrink-0">
        ...
        <Menu className="w-6 h-6 text-neutral-400 cursor-pointer hover:text-white md:hidden" />
      </div>
    </nav>
  );
}